...
import { changeUrl, getChangeUrl, getCompany } from '@/libs/util'
...
export default {
  ...
  created () {
    ...
    this.dbTable.searchTable.table.data.ownerIdentifier = companyCodes
    this.dbTable.tabsTable.table.data.ownerIdentifier = companyCodes
    this.materModal.searchTable.table.data.ownerIdentifier = companyCodes
    this.getStatus()
    this.getAuditStatus()
    this.getCategory()
  },
  ...
  watch: {
    ...
    materFligure (val) {
      ...
      !val && this.$nextTick(() => {
        ...
        // this.dbTable.tabsTable.table.buttonsOther = false
    ...
    getSearch (val) {
      console.log(this.modalData.visible)
      console.log(val)
      if (!this.modalData.visible) {
        this.dbTable.searchTable.table.data = { ...this.dbTable.searchTable.table.data, ...val }
        if (!val.reset) this.changeStatus()
    ...
    getChoseTr (val) {
      if (!this.modalData.visible) {
        if (!isEmptyObject(val) && val.creater) {
          ...
          this.dbTable.tabsTable.table.data.ownerType = val.ownerType
          this.dbTable.tabsTable.table.data.ownerIdentifier = val.ownerIdentifier

          this.dbTable.tabsTable.table.modal.data.planId = val.id

          // this.dbTable.tabsTable.table.modal.baseData.add.planId = val.id
          // this.dbTable.tabsTable.table.modal.baseData.add.ownerType = val.ownerType
          // this.dbTable.tabsTable.table.modal.baseData.add.ownerIdentifier = val.ownerIdentifier
